		...
		<section id={sectionId} className={styles.swiperSection}>
			<div className="container">
				<div className={styles.swiperSection__top}>
					<h2 className="h2">Наши услуги для вашего бизнеса</h2>
					<p>
						Мы предлагаем полный спектр маркетинговых решений — от привлечения клиентов до анализа данных. 
						Выберите направление, которое поможет вашему бизнесу расти, или закажите комплексное продвижение.
					</p>
				</div>
				<UiSwiper
					slides={slides}
